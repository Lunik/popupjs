function _Popup(){function t(t){return t&&(t=t.toString(),t.indexOf("%")!==-1&&(t=t.split("%")[0],t=parseInt(t*$(window).width()/100,10))),t}function i(t){return t&&(t=t.toString(),t.indexOf("%")!==-1&&(t=t.split("%")[0],t=parseInt(t*$(window).height()/100,10))),t}function s(t){return i(t)}this.init=function(o){this.posX=s(o.pos.x),this.posY=s(o.pos.y),this.width=t(o.width),this.height=i(o.height),this.title=o.title,this.html=o.html.clone(),this.closeBut=o.closeBut},this.draw=function(){var t=$("<div>").addClass("popupShadow").click(function(){this.remove()})
this.selector=t
